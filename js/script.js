...
// Screol MyApps : animation pause au hover
document.addEventListener('DOMContentLoaded', function(){
  const appList = document.querySelector('.app-list');
  if(appList){
    appList.addEventListener('mouseenter', ()=> appList.style.animationPlayState = 'paused');
    appList.addEventListener('mouseleave', ()=> appList.style.animationPlayState = 'running');
  }
});

const myApps = document.querySelectorAll('#scrollerV');
