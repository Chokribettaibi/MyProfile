...
class Particle {
    constructor(effect){
        ...
        this.colors = ['#4c026b', '#00f', '#730d9e', 'red', '#9622c7','wite', '#b44ae0','#b52566', '#cd72f2'];
...
class Effect {
    ...
    drawText(){
        ...
        gradient1.addColorStop(0.8, 'rgb(150,100,100)');
        ...
        gradient1.addColorStop(0.8, 'rgb(150,255,255)');
        ...
        this.context.fillText('Bettaibi', this.width * 0.5, this.height * 0.2, this.width);
    }
    init(){
        // create flow field
