    ...
    //*/
      ...
      if (
        Math.abs(
          term_f(specific_point - global_epsilon) - term_f(specific_point),
        ) > global_epsilon
      ) {
        // point (specific_point-0;f(specific_point-0))
        var point_specific_point_minus_global_epsilon_fspecific_point_minus_global_epsilon =
          board.create(
            "point",
            [
              specific_point - global_epsilon,
              term_f(specific_point - global_epsilon),
            ],
            {
              fillColor: "#ffffff",
              name: "",
        ...
        var point_specific_point_fspecific_point = board.create(
          "point",
          [specific_point, term_f(specific_point)],
          {
            fillColor: "#4080aa",
            name: "",
            size: 1,
        ...
        var line_specific_point_0_specific_point_fmax_specific_point_or_specific_point_minus_0 =
          board.create(
            "line",
            [
              [specific_point, 0],
      ...
      var line_parallel_x_axis = board.create(
        "line",
        [
          [x0_start, cx],
          [x0_end, cx],
      ...
      var glider_x0_0 = board.create(
        "glider",
        [x0_init, 0, line_parallel_x_axis],
        {
          fillColor: "#ff00ff",
          label: {
            offset: [-5, -15],
    ...
    */
      ...
      var point_x0_0 = board.create(
        "intersection",
        [x_axis, line_x0_0_x0_fx0],
        {
          fillColor: "#000000",
          label: {
            offset: [-20, -35],
      ...
      var line_x0_fx0_0_fx0 = board.create(
        "line",
        [point_x0_fx0, point_0_fx0],
        {
          dash: 2,
          straightFirst: false,
          straightLast: false,
      ...
      // point (cx,f(x0)+1)
      var point_cx_fx01 = board.create(
        "point",
        [
          function () {
      ...
      var line_0_fx0_cx_fx0 = board.create(
        "line",
        [point_0_fx0, point_cx_fx0],
        {
          dash: 2,
          straightFirst: false,
          straightLast: false,
      ...
      var line_cx_fx0_cx_fx01 = board.create(
        "line",
        [point_cx_fx0, point_cx_fx01],
        {
          straightFirst: false,
          visible: false,
        },
      ...
      // epsilon glider
      var glider_cx_fx0_espilon = board.create(
        "glider",
        [
          0,
          (function () {
      ...
      var line_cx_fx0_cx_fx0_epsilon = board.create(
        "line",
        [point_cx_fx0, glider_cx_fx0_espilon],
        {
          straightFirst: false,
          straightLast: false,
          strokeColor: "#00dd66",
      ...
      var point_label_epsilon = board.create(
        "midpoint",
        [point_cx_fx0, glider_cx_fx0_espilon],
        {
          label: {
      ...
      var point_cx_fx0_minus_epsilon = board.create(
        "mirrorpoint",
        [glider_cx_fx0_espilon, point_cx_fx0],
        {
          fillColor: "#000000",
          label: {
            offset: [-55, -20],
      ...
      var line_cx_fx0_cx_fx0_minus_epsilon = board.create(
        "line",
        [point_cx_fx0, point_cx_fx0_minus_epsilon],
        {
          dash: 1,
          straightFirst: false,
          straightLast: false,
      ...
      var point_0_fx0_epsilon = board.create(
        "point",
        [
          0,
          function () {
      ...
      // point (0,f(x0)-epsilon)
      var point_0_fx0_minus_epsilon = board.create(
        "point",
        [
          0,
          function () {
      ...
      var line_cx_fx0_epsilon_0_fx0_epsilon = board.create(
        "line",
        [glider_cx_fx0_espilon, point_0_fx0_epsilon],
        {
          dash: 1,
          straightFirst: false,
          straightLast: true,
      ...
      // line (cx;f(x0)-epsilon) - (0;f(x0)-epsilon)
      var line_cx_fx0_minus_epsilon_0_fx0_minus_epsilon = board.create(
        "line",
        [point_cx_fx0_minus_epsilon, point_0_fx0_minus_epsilon],
        {
          dash: 1,
          straightFirst: false,
          straightLast: true,
      ...
      var line_x0_cy_x01_cy = board.create(
        "line",
        [point_x0_cy, point_x01_cy],
        {
          straightFirst: false,
          visible: false,
        },
      ...
      // delta glider
      var glider_x0_delta_cy = board.create(
        "glider",
        [
          (function () {
      ...
      var line_x0_cy_x0_delta_cy = board.create(
        "line",
        [point_x0_cy, glider_x0_delta_cy],
        {
          straightFirst: false,
          straightLast: false,
          strokeColor: "#ffaa33",
      ...
      // point (x0-delta;cy)
      var point_x0_minus_delta_cy = board.create(
        "mirrorpoint",
        [glider_x0_delta_cy, point_x0_cy],
        {
          fillColor: "#000000",
          label: {
            offset: [-50, -10],
      ...
      var line_x0_cy_x0_minus_delta_cy = board.create(
        "line",
        [point_x0_cy, point_x0_minus_delta_cy],
        {
          dash: 1,
          straightFirst: false,
          straightLast: false,
      ...
      var point_label_delta = board.create(
        "midpoint",
        [point_x0_cy, glider_x0_delta_cy],
        {
          label: {
      ...
      // point (x0+delta;0)
      var point_x0_delta_0 = board.create(
        "point",
        [
          function () {
      ...
      // point (x0-delta;0)
      var point_x0_minus_delta_0 = board.create(
        "point",
        [
          function () {
      ...
      // point (x0+delta;cym)
      var point_x0_delta_cym = board.create(
        "point",
        [
          function () {
            return glider_x0_delta_cy.X();
      ...
      // point (x0-delta;cym)
      var point_x0_minus_delta_cym = board.create(
        "point",
        [
          function () {
            return point_x0_minus_delta_cy.X();
      ...
      var line_x0_delta_cy_x0_delta_cym = board.create(
        "line",
        [glider_x0_delta_cy, point_x0_delta_cym],
        {
          dash: 1,
          straightFirst: false,
          straightLast: false,
      ...
      // dotted line (x0-delta;cy) - (x0-delta;cym)
      var line_x0_minus_delta_cy_x0_minus_delta_cym = board.create(
        "line",
        [point_x0_minus_delta_cy, point_x0_minus_delta_cym],
        {
          dash: 1,
          straightFirst: false,
          straightLast: false,
      ...
      var point_x0_delta_fx0_epsilon = board.create(
        "intersection",
        [line_x0_delta_cy_x0_delta_cym, line_cx_fx0_epsilon_0_fx0_epsilon, 0],
        {
          fillColor: "#000000",
          name: "",
          size: 1,
      ...
      // point (x0-delta;f(x0)+epsilon)
      var point_x0_minus_delta_fx0_epsilon = board.create(
        "intersection",
        [
          line_x0_minus_delta_cy_x0_minus_delta_cym,
          line_cx_fx0_epsilon_0_fx0_epsilon,
          0,
        ],
        {
          fillColor: "#000000",
      ...
      var point_x0_delta_fx0_epsilon = board.create(
        "intersection",
        [
          line_x0_delta_cy_x0_delta_cym,
          line_cx_fx0_minus_epsilon_0_fx0_minus_epsilon,
          0,
        ],
        {
          fillColor: "#000000",
      ...
      var line_x0_minus_delta_0_x0_delta_0 = board.create(
        "line",
        [point_x0_minus_delta_0, point_x0_delta_0],
        {
          straightFirst: false,
          straightLast: false,
          visible: false,
      ...
      // x glider
      var glider_x_0 = board.create(
        "glider",
        [glider_x0_0.X() + delta / 2, 0, line_x0_minus_delta_0_x0_delta_0],
        {
          fillColor: "#3366ff",
          label: {
            offset: [-4, -15],
      ...
      var polygon_delta_epsilon = board.create(
        "polygon",
        [
          point_x0_0,
          glider_x_0,
